...
// This fucntion is used to create an ordered linked list using the order of the CompareFunc
void list_insert_ordered(List list, Pointer value, CompareFunc compare);
